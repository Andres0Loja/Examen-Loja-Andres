...
a persistence unit "operadoraPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "operadora\pom.xml":
...
artifact ("operadora.war") is already built. You can build
