...
a persistence unit "LojaAndresSRIJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "LojaAndresSRIJEE\pom.xml":
...
artifact ("LojaAndresSRIJEE.war") is already built. You can build
